    ...
    $(document).ready(function() {
        ...
        indexer.on('click', function(e) {
            ...
            var target = $(e.target),
                ...
                status = indexer.siblings('.uvp-zip-status'),
                errorDetails = indexer.siblings('.uvp-zip-error-details');
            ...
            $.ajax({
                type: 'POST',
                url: GravAdmin.config.base_url_relative + '.json/task' + GravAdmin.config.param_sep + 'reindexUVPZip',
